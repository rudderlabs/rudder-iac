...
func TestProcessCustomTypesIntoContext_VariantsEmitDiscriminatedUnion(t *testing.T) {
	...
	assert.Equal(t, TSInterfaceProperty{Name: "page_type", Type: `"search"`, Comment: "", Optional: false}, searchIface.Properties[0])
	...
	assert.Equal(t, TSInterfaceProperty{Name: "page_type", Type: `Exclude<string, "search">`, Comment: "", Optional: false}, defaultIface.Properties[0])
}
