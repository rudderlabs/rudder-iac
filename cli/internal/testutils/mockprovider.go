...
func NewMockProvider(supportedKinds, supportedTypes []string) *MockProvider {
	return &MockProvider{
		...
		ParseSpecVal:            &specs.ParsedSpec{URNs: []specs.URNEntry{}},
...
func (m *MockProvider) LoadImportable(_ context.Context, _ namer.Namer, _ ...resources.ImportableFilter) (*resources.RemoteResources, error) {
	return nil, nil
}
