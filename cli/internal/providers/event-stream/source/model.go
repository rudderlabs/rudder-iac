...
// V1 spec structs use the new tracking plan reference format (#tracking-plan:<id>)

// SourceSpecV1 mirrors the YAML spec structure for V1 specs.
// The only difference from SourceSpec is the tracking plan reference pattern.
