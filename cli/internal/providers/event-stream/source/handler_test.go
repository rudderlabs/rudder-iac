...
func TestEventStreamSourceHandler(t *testing.T) {
	...
	t.Run("GetResources", func(t *testing.T) {
		...
		assert.Equal(t, resources.ResourceData{
			...
			"tracking_plan": &resources.PropertyRef{
				URN:      resources.URN("tp-123", core.TrackingPlanResourceType),
				Property: "id",
			},
	...
	t.Run("LoadStateFromResources", func(t *testing.T) {
		...
		collection.Set(core.TrackingPlanResourceType, trackingPlanResourceMap)
		...
		assert.Equal(t, &state.ResourceState{
			...
			Input: resources.ResourceData{
				...
				"type":    "javascript",
				"tracking_plan": &resources.PropertyRef{
					URN:      resources.URN("external-tp-789", core.TrackingPlanResourceType),
					Property: "id",
				},
				"tracking_plan_config": map[string]interface{}{
					"track": map[string]interface{}{
