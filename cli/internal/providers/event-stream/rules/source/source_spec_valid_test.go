...
func TestSourceSpecSyntaxValidRule_AllSourceTypes(t *testing.T) {
	...
	sourceTypes := []string{
		...
		"go", "node", "ocaml", "ruby", "unity", "swift", "kotlin",
	}
...
func TestSourceSpecSyntaxValidRule_InvalidSpecs(t *testing.T) {
	...
	tests := []struct {
		...
		},
		{
			...
			wantMessages: []string{
				"'type' must be one of [java dotnet php flutter cordova rust react_native python ios android javascript go node ocaml ruby unity swift kotlin]",
			},
		},
		{
