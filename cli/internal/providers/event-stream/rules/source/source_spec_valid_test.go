...
func TestSourceSpecSyntaxValidRule_AllSourceTypes(t *testing.T) {
	...
	sourceTypes := []string{
		...
		"go", "node", "ruby", "unity", "ios_swift", "android_kotlin",
	}
...
func TestSourceSpecSyntaxValidRule_InvalidSpecs(t *testing.T) {
	...
	tests := []struct {
		...
		},
		{
			...
			wantMessages: []string{
				"'type' must be one of [java dotnet php flutter cordova rust react_native python ios android javascript go node ruby unity ios_swift android_kotlin]",
			},
		},
		{
...
// V1 Spec Validation Tests

func TestSourceSpecSyntaxValidV1Rule_ValidSpecs(t *testing.T) {
	t.Parallel()
...
func TestSourceSpecSyntaxValidV1Rule_AllSourceTypes(t *testing.T) {
	t.Parallel()
...
func TestSourceSpecSyntaxValidV1Rule_InvalidSpecs(t *testing.T) {
	t.Parallel()
