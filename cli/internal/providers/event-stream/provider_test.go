...
func TestProvider(t *testing.T) {
	t.Run("SupportedKinds", func(t *testing.T) {
		provider := eventstream.New(source.NewMockSourceClient(), eventstream.WithConnectionSupport(&connection.MockConnectionClient{}))
	...
	t.Run("SupportedMatchPatterns", func(t *testing.T) {
		...
		p := eventstream.New(source.NewMockSourceClient(), eventstream.WithConnectionSupport(&connection.MockConnectionClient{}))
	...
	// routes them to the connection handler, which drives the connections
	// API client.
	t.Run("ConnectionLifecycleRoutesToConnectionsClient", func(t *testing.T) {
		mockConnections := &connection.MockConnectionClient{}
		p := eventstream.New(source.NewMockSourceClient(), eventstream.WithConnectionSupport(mockConnections))
		...
		assert.Equal(t, []string{"Create"}, mockConnections.Calls)
	})
	...
	t.Run("Import", func(t *testing.T) {
		...
		provider := eventstream.New(mockClient, eventstream.WithConnectionSupport(&connection.MockConnectionClient{}))
		ctx := context.Background()
