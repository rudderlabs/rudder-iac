...
func TestProvider(t *testing.T) {
	t.Run("SupportedKinds", func(t *testing.T) {
		provider := eventstream.New(source.NewMockSourceClient(), &connection.MockConnectionClient{}, true)
	...
	t.Run("ConnectionSupportDisabled", func(t *testing.T) {
		provider := eventstream.New(source.NewMockSourceClient(), &connection.MockConnectionClient{}, false)
	...
	t.Run("ConnectionLifecycleRoutesToConnectionsClient", func(t *testing.T) {
		...
		p := eventstream.New(source.NewMockSourceClient(), mockConnections, true)
	...
	t.Run("Import", func(t *testing.T) {
		...
		provider := eventstream.New(mockClient, &connection.MockConnectionClient{}, true)
		ctx := context.Background()
