...
func TestSourceTypeToken(t *testing.T) {
	...
	cases := []struct {
		...
		{name: "kotlin sdk falls back to cloud", sourceType: "kotlin", want: common.SourceTypeCloud},
		{name: "swift sdk falls back to cloud", sourceType: "swift", want: common.SourceTypeCloud},
