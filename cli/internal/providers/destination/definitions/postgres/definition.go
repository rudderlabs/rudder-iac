...
type postgresConfig struct {
	Host     string `mapstructure:"host" validate:"required,dynamic_or_pattern=postgres_host"`
	...
	SSHPublicKey string `mapstructure:"ssh_public_key" validate:"required_if=UseSSH true,omitempty,dynamic_or_pattern=single_line_1000"`
	...
	SSLMode       string         `mapstructure:"ssl_mode" validate:"required,dynamic_or_oneof=disable require verify-ca"`
