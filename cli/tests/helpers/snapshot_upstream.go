...
func (u *UpstreamSnapshotTester) upstreamEntity(ctx context.Context, entityID, entityType string) (any, error) {
	...
	case core.PropertyResourceType:
	...
	case core.TrackingPlanResourceType:
	...
	case core.CustomTypeResourceType:
	...
	case core.CategoryResourceType:
