...
- Uses reference tracking plan from `typer/plan/testutils`

**Run tests:**

```bash
go test ./typer/generator/platforms/kotlin/...
```
...
- After changing reference tracking plan in `typer/plan/testutils/reference_plan.go`
