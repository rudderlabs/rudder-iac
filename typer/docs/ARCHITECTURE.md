...
- **Current Implementation**: Located in `typer/generator/core/`
- **Key Types**:
...
- **Current Implementation**: Located in `typer/generator/core/name_registry.go`
- **Key Features**:
...
**Current Implementation**: Located in `typer/plan/plan.go`
...
**Current Implementation**: Located in `typer/generator/platforms/kotlin/context.go`
...
- **Location**: `typer/plan/testutils/reference_plan.go`
...
5. **Run tests** to verify the changes: `go test ./typer/...`
...
- **Location**: `typer/generator/platforms/kotlin/testdata/validator/`
...
Add your generator to the platform registry in `typer/generator/platforms.go`:
