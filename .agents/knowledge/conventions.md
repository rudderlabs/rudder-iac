...
## DOCS-2434 — Release archive naming mirrors platform matrix
<!-- ticket:DOCS-2434 -->
- Installation docs should mirror the release artifact matrix instead of inventing separate naming: macOS/Linux archives use `.tar.gz`, Windows archives use `.zip`, and the OS/arch tokens should stay aligned with the release packaging conventions (`Darwin`, `Linux`, `Windows`; `arm64`, `x86_64`, `i386`).
