...
* [rudder-cli telemetry disable](rudder-cli_telemetry_disable.md)	 - Disable telemetry
* [rudder-cli telemetry enable](rudder-cli_telemetry_enable.md)	 - Enable telemetry
* [rudder-cli telemetry status](rudder-cli_telemetry_status.md)	 - Show current telemetry status
